...
\todo[inline]{Perhaps you should start by saying recall that WMC is a
  ...
  regards to (insert bullet point list from chapter 1, just before the start of
...
\todo[inline,caption={}]{
  \begin{itemize}
    \item You could mention the use of portfolio approaches to make SAT
          extremely fast \citep{DBLP:journals/jair/XuHHL08}, and whether
          something similar could be tried out with your work.
    \item Likewise you could reference the work on approximate counting as
...
future work remain. An interesting opportunity to connect our work on random
