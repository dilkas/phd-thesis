...
% TODO (V, below): Maybe mention testing our contributions in ML + Robotics
% applications also important... will let us know significance of encoding
% improvement (i.e., more expressive encoding = potentially faster
% applications). Also can ML + Robotics provide strategies for new benchmarking
% algorithms (i.e., more comprehensive set of benchmarks or a better alignment
...
% TODO (V): Can it play a key role in integrating reasoning and learning? Can it
% play a role in language understanding as symbolic/syntactic [?]?
