...
\paragraph{Theory and computational complexity.}
\begin{itemize}
...
\item prove that transitivity cannot be computed in polynomial time. Arithmetic hardness for various sumprod/counting problems.
...
\item Another important avenue for future research is on the expressive power of various logics and languages. Mention $f(n) = f(f(n-1))$. A different kind of completeness: what kind of sequences and integer functions can be encoded in FOL? What about other kinds of logics and languages?
\end{itemize}
