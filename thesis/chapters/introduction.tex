...
% TODO (V) (after `probabilistic inference'): for example, the partition
% function or marginal or conditional probability given a Bayesian network

% TODO (V) (instead of `probability from a collection of other known
% probabilities'): the probability of an event given an event space
...
% TODO (V): (after 'is known as'): AMC (Kimmig et al.) and its continuous
% generalisation is SP
...
% TODO (V) (after 'network reliability analysis'): See AMC paper for discussions
...
ways.
% TODO (V): we particularly find the semantics and benchmarking WMC need further
% study, which is precisely what we explore.
...
% TODO (V) (until 'another important'): these motivated by semantic and encoding concerns
% TODO (V) (after 'another important'): these motivated by benchmarking concerns
...
% TODO (V): subsection: details on contributions
...
bijections.
% TODO (V) ('counting ... bijections'): emphasize it
