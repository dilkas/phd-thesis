...
% TODO (V): Here as well you seem to have used the introduction from the paper
% but somehow it seems fine here. Mainly because it's self-contained. But just
% check once more that it is connecting nicely with the previous chapters and
% you are positioning your own contribution in an effective manner.
