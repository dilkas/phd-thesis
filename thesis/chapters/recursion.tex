...
\todo[inline,caption={}]{
  \begin{itemize}
    \item Refer to previous work for the interpretations of other
          node types and for the definition of groundings.
    \item Finish writing this paragraph. Here we provide an informal
          ...
          \begin{itemize}
            ...
            \item $\Reff$ is interpreted as a function call. The target of the
                  outgoing edge then must introduce a new function, the
                  parameters of which are the sizes of all domains reachable
                  from it.
            \item $\GDR$ node does not contribute anything to the definitions of
                  functions.
            \item Same with $\CR$ nodes.
            \item Obviously, $\star$ has no interpretation because incomplete
                  FCGs are not meant to be interpreted.
          \end{itemize}
