...
% TODO: change "ForcLift [Van den Broecket al., 2011] can construct recursive functions that efficiently solve countingproblems that used to be beyond its reach." 
% to
% ForcLift [Van den Broecket al., 2011] is adapted to be able to construct recursive functions that efficiently solve countingproblems that used to be beyond its reach previously.
...
% TODO (V): It might be worth emphasising that you are introducing new notation in new concepts to provide a metatheory to the existing literature on listed reasoning
\begin{definition}
...
% TODO (V): It might be good to clarify which of this notation is new and which of this is from previous work.
...
% TODO (V): Again here good to clarify which of the notation is New. But more importantly it would have been useful to just have a short discussion of what the contribution here exactly is. 
\begin{definition}
...
% TODO (V): I understand that you have a fix or improvement to the existing procedure, but I hope you’re aware of how this is a noteworthy contribution from a high-level perspective
...
TODO: Compare with the original \citep{DBLP:conf/nips/Broeck11}.
...
\paragraph{Results.}
\begin{itemize}
  % TODO (V): Just to be clear for my understanding, the improvements and the alterations of the algorithms in the above pages are completely in service of extending the lifting algorithm to account for these new formulas, right? That is in other  words your contribution here is showing how the algorithms can be further extended to account for these additional formulas, & that’s what the paper is about?
