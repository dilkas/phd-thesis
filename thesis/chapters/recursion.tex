...
Our definition of a constraint is stricter than that of
\citet{DBLP:conf/ijcai/BroeckTMDR11}. In particular, the mapping from variables
to domains is moved to the definition of a clause (\cref{def:clause}).
...
\todo[inline]{V: It might be worth emphasising that you are introducing new
  ...
  listed reasoning.}
\begin{definition} \label{def:clause}
