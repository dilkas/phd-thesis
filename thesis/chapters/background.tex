...
describe some of the ways of representing a probability distribution.
...
representations also differ in their ability to reason about groups of random
...
Note that although we use Bayesian network probabilistic inference as a central
examples on several occasions, our research is chiefly foundational and not
necessarily motivated by any one application.
