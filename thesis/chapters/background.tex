...
\begin{figure}[t]
  ...
  \begin{subfigure}{0.49\textwidth}
    ...
    \begin{tikzpicture}[node distance=1.5cm]
      \node[draw,ellipse] (alarm) {A};
      \node[draw,ellipse,above left of=alarm] (burglary) {B};
      \node[draw,ellipse,above right of=alarm] (earthquake) {E};
      \node[draw,ellipse,below left of=alarm] (johnCalls) {J};
      \node[draw,ellipse,below right of=alarm] (maryCalls) {M};
