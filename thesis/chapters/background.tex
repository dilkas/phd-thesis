...
% TODO (V): a word on semantics? or not needed? or refer to problog chapter?
...
% TODO (V): might be good to give general definition of probability space (cf
% Halperin 2003). Maybe just point the reader to some books, e.g., the PGM book,
% the Stroock's book, maybe the Loeve's book (Probability Theory, Vol 1)
...
\begin{table}[t]
  ...
  \begin{tabular}[t]{lllr}
    ...
    \midrule
    \rowcolor{gray!10}\multicolumn{2}{c}{} & \false{} & 0.999 \\
    \rowcolor{gray!10}\multicolumn{2}{c}{\multirow{-2}{*}{\false{}}} & \true{} & 0.001 \\
    & & \false{} & 0.71 \\
    \multirow{-2}{*}{\false{}} & \multirow{-2}{*}{\true{}} & \true{} & 0.29 \\
    \rowcolor{gray!10}& & \false{} & 0.06 \\
    \rowcolor{gray!10}\multirow{-2}{*}{\true{}} & \multirow{-2}{*}{\false{}} & \true{} & 0.94 \\
...
\begin{lstlisting}[caption=A ProbLog program that computes
  ...
  query(burglary).
\end{lstlisting}
% TODO (V): semantics of problog? Or, later?
...
% TODO (V): As should be clear from our discussion, our research fundamental,
% foundational, and not necessarily motivated by any one application.
