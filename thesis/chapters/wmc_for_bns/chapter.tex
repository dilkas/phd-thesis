...
\begin{lemma} \label{lemma:cpt}
  ...
  \mathbb{R}_{\ge 0}$ is such that for any $x \in \Imm X$ and $(y_1, \dots, y_n)
  \in \prod_{i=1}^n \Imm Y_i$,
  \[
...
network. If $\mathsf{true} \in \Imm X$, then we compute the marginal probability
