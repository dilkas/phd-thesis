...
\documentclass[phd,aiai,twoside,singlespacing,logo]{infthesis}
...
% * introduction, background: merge table cells with the same info
...
% * also list contributions in conclusion and at the beginning of each chapter
...
% * conclusion: don't repeat the conclusions of individual chapters. Reiterate the importance of the work.
...
% * do I want to leave the abstracts in? If so, mention them at the end of the introduction and in the relevant chapters.
