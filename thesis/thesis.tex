...
\abstract{Given a formula in propositional or first-order logic and some
  ...
  on WMC include explainable AI, neuro-symbolic AI, probabilistic programming,
...
% * Figures/tables: alignment issues
...
% * fonts for names of problems (e.g., SAT, #SAT, WMC, FOMC, WFOMC) (no font)
