...
% TODO:
% * !!! incorporate new feedback in all content chapters
...
% * capitalisation and font for predicates (lowercase), variables (uppercase), constants (lowercase), etc.
% * textsc for algorithm names (e.g., problog, prolog, forclift, Crane, all WMC algorithms including DPMC, ADDMC, Ace, maybe some others)
