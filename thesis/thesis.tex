...
% * make all the arrows in tikz pictures (and tree sibling and node distances) all the same. Use -Latex. Only recursion.tex remains (for arrows, not node distances).
...
% * nodes vs vertices
% * have a ~ before every citep and citet
