  ...
  \begin{frame}<beamer>
    ...
    \ifthenelse{\boolean{future}}{
      ...
      \begin{tikzpicture}[overlay]
        \node at ($(current page.center)!.3!(current page.east)$) {\includegraphics[width=0.7\textwidth]{fiction2.png}};
      \end{tikzpicture}
    }{
    \tableofcontents[currentsection]
    }
  ...
  \begin{columns}
    \begin{column}{0.27\textwidth}
      \onslide<9->{
        ...
        \item cyclicity
        \item independence
%        \item[\textcolor{gray}{\textbullet}] \textcolor{gray}{required subformulas}
        \end{itemize}
      }
    \end{column}
