...
% \end{scope}
\begin{scope}
\path[clip] ( 25.78, 19.53) rectangle (223.31,172.66);
\definecolor{drawColor}{RGB}{27,158,119}

\node[anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (205.30, 77.98) {predicates};
\end{scope}
% \begin{scope}
% \path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (205.54, 65.59) {variables};
\end{scope}
% \begin{scope}
% \path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (205.85, 53.19) {constants};
\end{scope}
% \begin{scope}
% \path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (189.68, 90.33) {extra clauses};
\end{scope}
% \begin{scope}
% \path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
...
\node[anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (203.37,163.74) {nodes};
\end{scope}
% \begin{scope}
% \path[clip] ( 25.78, 19.53) rectangle (213.31,172.66);
% \definecolor{drawColor}{RGB}{217,95,2}
...
\node[anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.57] at (136.94, 78.52) {max arity};
\end{scope}
\begin{scope}
