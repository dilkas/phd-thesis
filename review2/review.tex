...
\Cref{sec:representations} describes various ways to represent a probability
distribution and lists some applications. \Cref{sec:inference} covers
...
% In fact, efforts to unify probability and logic have a history going back to
% mid-1980s \cite{DBLP:journals/ndjfl/Hailperin84,DBLP:journals/ai/Nilsson86}.
...
% Related: direct compilation to SDDs \cite{DBLP:conf/ecsqaru/ChoiKD13}
% and probabilistic SDDs \cite{shen2020modeling}.
